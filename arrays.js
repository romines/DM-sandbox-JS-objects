...
var best_numbers = [0,3,4,5,6,7,9,14,17,24,25,26,29,30];
...
*/
  ...
  function removeItem(list, checkItem) {
...
//Your Code Here
  var user2 = {
      name: 'Joe Schmoe',
      email: 'nnis33@gmail.com',
      password: 'iLipt',
      username: 'inLoop'
  };
  var user3 = {
      name: 'Jane Schmoe',
      email: 'Janeis33@gmail.com',
      password: 'sadlkiLipt',
      username: 'JaneLoop'
  };
...
Once you find the particular index he's located in, delete him from the array.*/
  ...
  function rmUser(arr) {
    return arr.filter(
      function(user){
        return user.email !== "tylermcginnis33@gmail.com";
      }
    );
  }
